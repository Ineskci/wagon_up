...
export default class extends Controller {
  ...
  appendBot(content, score = null) {
    ...
    this.appendMessage("bot", `
      <div class="wu-chloe-avatar" style="width:32px;height:32px;flex-shrink:0"><img src="/assets/chloe_avatar.png" alt="Chloe" style="width:100%;height:100%;object-fit:cover;border-radius:50%"></div>
