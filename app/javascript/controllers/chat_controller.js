...
export default class extends Controller {
  ...
  appendBot(content, score = null) {
    ...
    this.appendMessage("bot", `
      <div class="wu-chloe-avatar" style="width:56px;height:56px;flex-shrink:0"><img src="/assets/chloe_avatar.png" alt="Chloe" style="width:100%;height:100%;object-fit:cover;border-radius:50%;transform:scale(1.9)"></div>
